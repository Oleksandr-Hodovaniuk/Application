...
internal class DefaultSeeder(CoWorkingDbContext dbContext) : ISeeder
{
    ...
    private List<Icon> GetIcons()
    {
        ...
        {
            new Icon { Name = "Air conditioning"},
            new Icon { Name = "Gamepad"},
            new Icon { Name = "Wifi"},
            new Icon { Name = "Coffee"},
            new Icon { Name = "Headphones"},
            new Icon { Name = "Microphone"},
            new Icon { Name = "User"},
            new Icon { Name = "Armchair"},
            new Icon { Name = "Clock"},
            new Icon { Name = "Calendar"},
            new Icon { Name = "Edit"},
            new Icon { Name = "Trash"},
            new Icon { Name = "Chevron"},
            new Icon { Name = "X"},
            new Icon { Name = "Done"},
            new Icon { Name = "Big done"},
            new Icon { Name = "Big cancel"},
            new Icon { Name = "Big trash"},
        };
    }
